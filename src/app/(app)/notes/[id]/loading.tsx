export default function NoteEditorLoading() {
  return (
    <div className="-mx-4 -mt-5 w-auto pb-10 md:-mx-6 md:-mt-6">
      <div className="mx-auto mb-4 flex w-full max-w-[1360px] items-center justify-between gap-4 px-4 pt-4 sm:px-6 sm:pt-5 md:px-10 md:pt-6">
      ...
      <div className="mx-auto w-full max-w-[980px] px-4 sm:px-6 md:px-10">
