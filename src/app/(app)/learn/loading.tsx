  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div className="h-8 w-40 animate-pulse rounded-lg bg-stone-200/60 dark:bg-stone-800/60" />
        ...
        {Array.from({ length: 4 }).map((_, i) => (
          ...
          >
            <div className="space-y-3">
              <div className="h-5 w-1/2 animate-pulse rounded bg-stone-200/60 dark:bg-stone-800/60" />
              <div className="h-3 w-full animate-pulse rounded bg-stone-100/60 dark:bg-stone-800/40" />
              <div className="h-3 w-3/4 animate-pulse rounded bg-stone-100/60 dark:bg-stone-800/40" />
            </div>
          </div>
        ))}
      </div>
