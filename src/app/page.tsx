      ...
      <div className="grid md:grid-cols-3 gap-6">
        ...
        <div>
          <div className="flex items-center justify-between mb-3">
            <h2 className="text-sm font-medium text-gray-500">最近笔记</h2>
        ...
        <div>
          <div className="flex items-center justify-between mb-3">
            <h2 className="text-sm font-medium text-gray-500">最近收藏</h2>
          ...
          <div className="space-y-2">
            {isLoading ? (
              ...
              data?.pendingTodos.map((todo) => (
                <div
                  key={todo.id}
                  className="flex items-center gap-2 p-3 border border-gray-100 rounded-lg"
                >
