...
--> statement-breakpoint
CREATE INDEX `oauth_authorization_codes_user_client_idx` ON `oauth_authorization_codes` (`user_id`,`client_id`);
--> statement-breakpoint
...
--> statement-breakpoint
CREATE UNIQUE INDEX `oauth_refresh_tokens_token_hash_idx` ON `oauth_refresh_tokens` (`token_hash`);
--> statement-breakpoint
...
--> statement-breakpoint
CREATE UNIQUE INDEX `oauth_access_tokens_token_hash_idx` ON `oauth_access_tokens` (`token_hash`);
--> statement-breakpoint
CREATE INDEX `oauth_access_tokens_user_client_idx` ON `oauth_access_tokens` (`user_id`,`client_id`);
--> statement-breakpoint
CREATE INDEX `oauth_access_tokens_refresh_token_idx` ON `oauth_access_tokens` (`refresh_token_id`);
--> statement-breakpoint
